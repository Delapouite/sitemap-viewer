...
function display(country, db, sitemap) {
	...
	table.append($('<tr><th colspan="8"><h2>' + country + ' : ' + sitemap.urlset.url.length + ' urls in sitemap, ' + Object.keys(db).length + ' dumped</h2></th></tr>'));
	// fields
	table.append($('<tr><th>lastmod</th><th>URL</th><th>en-US</th><th>Tags</th><th>Length</th><th>Last updated</th><th>Last editor</th><th>Last dump</th></tr>'));
